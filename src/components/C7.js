      ...
      <div className={styles.review}>
        <div className={styles.review1Parent}>
          <div className={styles.review1Child}>
            ...
            <svg className={styles.frameIcon} width="68" height="47" viewBox="0 0 68 47" fill="none" xmlns="http://www.w3.org/2000/svg">
<path fill-rule="evenodd" clip-rule="evenodd" d="M12.6281 10.5865C13.7116 10.3247 14.8191 10.1929 15.93 10.1935C24.7275 10.1935 31.8572 18.3415 31.8572 28.3885C31.8572 38.4385 24.7275 46.5865 15.93 46.5865C7.1325 46.5865 0 38.4415 0 28.3885C0 28.0945 0.005625 27.7975 0.0196875 27.5035H0C0 12.3385 10.8 -0.000488281 24.075 -0.000488281V6.10751C19.7691 6.10751 15.7978 7.78151 12.6281 10.5865ZM48.2737 10.5865C49.3369 10.3285 50.4394 10.1935 51.57 10.1935C60.3675 10.1935 67.5 18.3415 67.5 28.3885C67.5 38.4385 60.3675 46.5865 51.57 46.5865C42.7725 46.5865 35.6428 38.4415 35.6428 28.3885C35.6428 28.0945 35.6484 27.7975 35.6625 27.5035H35.6428C35.6428 12.3385 46.4428 -0.000488281 59.7178 -0.000488281V6.10751C55.4091 6.10751 51.4434 7.78151 48.2737 10.5865Z" fill="#C6E74A"/>
</svg>
